...
It does not read email content, calendar events, Drive files, documents, messages, contacts or account data.

All replacement icons are loaded locally from the extension package.
